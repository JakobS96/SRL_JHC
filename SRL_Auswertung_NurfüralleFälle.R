...
Zielsetzung.model2 <- lme(LZ04_01 ~ Feedback + gmc_GOALt1, random = ~ 1 + Feedback + TIME2.0|SERIAL, correlation=corAR1(),na.action = na.omit, data = D_T1LP_gmc2.0)
...
anova(Zielsetzung.model2, Zielsetzung.model) # p-Wert zwar signifikant, aber Modell mit Interaktion wird signifikant schlechter (s. logLikelihood Werte)
...
Zeitplan.model2 <- lme(TE06_01 ~ Feedback + gmc_PLANt1 , random = ~ 1 + Feedback + TIME2.0|SERIAL, correlation=corAR1(),na.action = na.omit, data = D_T1LP_gmc2.0)
summary(Zeitplan.model2)
...
anova(Zeitplan.model2, Zeitplan.model)

# Effektstaerke
lme.dscore(Zeitplan.model,data=D_T1LP_gmc2.0,type="nlme")

lme.dscore(Zeitplan.model2,data=D_T1LP_gmc2.0,type="nlme")
...
Zufriedenheit.model2 <- lme(TE10_01 ~ Feedback, random = ~ 1 + Feedback + TIME2.0|SERIAL, correlation=corAR1(),na.action = na.omit, data = D_T1LP_gmc2.0)
summary(Zufriedenheit.model2)
...
anova(Zufriedenheit.model, Zufriedenheit.model2)

# Effektstaerke
lme.dscore(Zufriedenheit.model,data=D_T1LP_gmc2.0,type="nlme")

lme.dscore(Zufriedenheit.model2,data=D_T1LP_gmc2.0,type="nlme")
...
Prokrastination.model2 <- lme(TE07_01 ~ Feedback + gmc_PROt1 , random = ~ 1 + Feedback + TIME2.0|SERIAL, correlation=corAR1(),na.action = na.omit, data = D_T1LP_gmc2.0)
summary(Prokrastination.model2)
...
anova(Prokrastination.model, Prokrastination.model2)

# Effektstaerke
lme.dscore(Prokrastination.model,data=D_T1LP_gmc2.0,type="nlme")

lme.dscore(Prokrastination.model2,data=D_T1LP_gmc2.0,type="nlme")
...
Anstrengung.model2 <- lme(TE08_01 ~ Feedback, random = ~ 1 + Feedback + TIME2.0|SERIAL, correlation=corAR1(),na.action = na.omit, data = D_T1LP_gmc2.0)
summary(Anstrengung.model2)
...
anova(Anstrengung.model, Anstrengung.model2)

# Effektstaerke
lme.dscore(Anstrengung.model,data=D_T1LP_gmc2.0,type="nlme")

lme.dscore(Anstrengung.model2,data=D_T1LP_gmc2.0,type="nlme")
